...
public class SendingEmail { 
 ...
 message.setFrom(new InternetAddress("testssdfsdender@noemail.com")); 
 message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("rfsfdsfezar@bu.edu")); 
 ...
 semail.sendMail("localhost", 1225, "someusername", "somepass"); 
